...
# we make a boxplot to have an idea about the consumption of our sample
ggplot() + geom_boxplot(data = Meat_var, aes(x = meat_cons)) + labs(title = "Meat consumption distribution", x = "Frequency", y = "Meat consumption")
...
ggplot() + geom_boxplot(data = dairy_var, aes(x = dairy_cons)) + labs(title = "Distribution of consumption of dairy products", x = "Frequency", y = "Diary products consumption")
# we use the function summary to display some statistical information
...
ggplot() + geom_boxplot(data = vege_var, aes(x = vege_cons)) + labs(title = "Distribution of vegetable consumption", x = "Frequency", y = "Vegetable consumption")
...
# we make a summary and a boxplot to have an idea about the consumption of our sample
ggplot() + geom_boxplot(data = fruit_var, aes(x = fruit_cons)) + labs(title = "Distribution of fruit consumption ", x = "Frequency", y = "Fruit consumption")
...
```{r, warning = FALSE}
# we make a summary and a boxplot to have an idea about the consumption of our sample
ggplot() + geom_boxplot(data = Dietary_vars, aes(x = diet)) + labs(title = " How healthy is the diet ? ", x = "Type", y = "Diet")
...
```{r}
# we make a boxplot using the function ggplot and boxplot and we add a tittle with a function labs
ggplot() + geom_boxplot(data = age_var, aes(x = age)) + labs(title = "Age distribution", x = "Year", y = "Age")
# we use the function summary to display some statistical information
summary(age_var$age)
...
```{r, warning = FALSE}
# we make a boxplot using the function ggplot and boxplot and we add a tittle with a function labs
ggplot() + geom_boxplot(data = income_var, aes(x = income)) + labs(title = "Income distribution", x = "Income Category", y = "Income")
...
```{r, warning = FALSE}
# we make a boxplot using the function ggplot and boxplot and we add a tittle with a function labs
ggplot() + geom_boxplot(data = physical_var, aes(x = avg_physical_activity)) + labs(title = "Physical activity distribution", x = "Category", y = "Physical activity")
# we use the function summary to display some statistical information
...
```{r, warning = FALSE}
# we make a boxplot using the function ggplot and boxplot and we add a tittle with a function labs
ggplot() + geom_boxplot(data = Alcohol_var, aes(x = avg_alcohol)) + labs(title = "Alcohol distribution", x = "Number of drinks", y = "Alcohol consumption")
# we use the function summary to display some statistical information
...
```{r, warning = FALSE}
# we make a boxplot using the function ggplot and boxplot and we add a tittle with a function labs
ggplot() + geom_boxplot(data = Smoking_var, aes(x = cigarets_per_day)) + labs(title = "Cigarettes per day distribution", x = "Number of cigarettes", y = "Cigarettes smoked")
# we use the function summary to display some statistical information
